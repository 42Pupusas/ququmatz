...
//! - [`layout`] — SQ/CQ ring memory layout: sizing, mmap'ing, and pointer
//!   parsing
...
use crate::syscall;
use crate::types::{
    CqeFlags, EnterFlags, Features, IoUringCqe, IoUringParams, IoUringSqe, RawFd, SetupFlags,
};
...
use layout::{map_rings, parse_cq, parse_sq};
